...
<script>
	export default {
		...
		methods: {
				...
				this.$refs[formName].validate((valid) => {
					if(valid) {
						if(this.emp.id) {
							//更新
							this.tableLoading = true;
							delete this.emp.posName;
							delete this.emp.workID;
							delete this.emp.salary;
							delete this.emp.departmentName;
			...
			showEditEmpView(row) {
				console.log("编辑员工"+JSON.stringify(row))
				...
				this.emp.notWorkDate = this.formatDate(row.notWorkDate);
